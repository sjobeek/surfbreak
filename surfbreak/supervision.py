# AUTOGENERATED! DO NOT EDIT! File to edit: 05_waveform_supervision.ipynb (unless otherwise specified).

__all__ = ['animate_tensor', 'show_image', 'wavefront_diff_tensor', 'dilate_tensor', 'vertical_waveform_slice',
           'generate_waveform_slice']
